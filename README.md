...
- A body failure or Job cancellation discards buffered progress and rejects pending receives. FlexJob observes its Job signal during the body so cancellation releases receivers even while uncooperative work has not stopped. Receiving does not interrupt that work; the Job still waits for its actual lifetime.
